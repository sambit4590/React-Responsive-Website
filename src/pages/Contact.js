    ...
    <>
      <div className=" ">
        <div className="relative">
          <section className="w-full h-[40vh] lg:h-[30vh] bg-cover bg-center brightness-50 bg-black"></section>
        ...
        <div className="w-full h-[1200px] md:h-[60vh] lg:h-[80vh] bg-blue-400 relative">
          <div className="absolute -top-[3%] md:-top-[10%] left-1/2 -translate-x-1/2 grid grid-cols-1 md:grid-cols-3 h-fit w-4/5 md:w-[90%] lg:w-4/5 rounded shadow overflow-hidden text-white">
            ...
            <div className="py-6 px-4 h-[500px] md:h-full bg-blue-800 grid grid-cols-1 grid-rows-5">
              <h2 className="text-xl lg:text-2xl text-center md:text-center font-semibold">
                Contact Information
              </h2>
